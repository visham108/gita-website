...
import { moneyINR, FREE_SHIPPING_THRESHOLD_PAISE, SHIPPING_FLAT_PAISE } from "@/lib/commerce";
...
export default function ShippingPolicy() {
  return (
    <PolicyPage title="Shipping Policy" updated="July 2026">
      ...
      <h2>Charges</h2>
      <p>
        Shipping is a flat {moneyINR(SHIPPING_FLAT_PAISE)} per order, and free for orders of{" "}
        {moneyINR(FREE_SHIPPING_THRESHOLD_PAISE)} or more. The exact charge is always shown
