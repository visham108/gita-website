...
const FAQ = [
  ...
  { q: "How long does it take to read?", a: "Cover to cover at a steady pace, most first-time readers take three to six months with the purports. Our free live course walks through the book's core teachings in seven sessions, which is a good way to start. But the honest answer is: a lifetime — the Gītā is a book one rereads forever, and it reads differently at every stage of life." },
